<template>
    <pageLayouts :pageTitle="pageTitle" :buttonTitle="buttonTitle"  :headers="headers">
        <template v-slot:page_top>
            <page-top :showAddButton="false" page-title="Role Permission"></page-top>
        </template>
        ...
        <template v-slot:thead>
            ...
            <th class="text-start">MENU AND PERMISSION </th>
            <th class="text-center">SUMMENU AND PERMISSION</th>
                        ...
                        <div v-for="sub in mod.submenus" :key="sub.id" class="mb-2  col-md-4 col-lg-4 col-sm-12">
                            ...
                            <div  v-if="sub.permissions && sub.permissions.length" class="ps-4">
                                <div v-for="subpar in sub.permissions" :key="subpar.id" class="d-flex align-items-center">
                                    <input  :checked="permissions.includes(subpar.id)" class="me-2" @click="setParmissions($event, '', subpar.id)" type="checkbox">
